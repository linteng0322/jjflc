...
public class CustomerDAOImpl extends BaseDAOImpl implements CustomerDAO{
	    ...
	    public Page<Customer> findCustomer(int pageIndex, int pageSize, int userId) {
	        ...
	        criteria.addOrder(org.hibernate.criterion.Order.desc("familyName"));
	    ...
	    public List<Customer> findCustomersBySearchtext(String searchText) {
	        ...
	        criteria.addOrder(org.hibernate.criterion.Order.desc("familyName"));
	        criteria.add(Restrictions.or(Restrictions.like("phone", "%"+searchText+"%"), Restrictions.like("familyName", "%"+searchText+"%"), Restrictions.like("address", "%"+searchText+"%")));
