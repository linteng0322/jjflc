		...
		<div style="float: right; width: 80%;">
			<sf:form servletRelativeAction="searchtransaction" method="post"
				...
				<div class="form-group">
					<div class="form-group">
						<div class="col-sm-3">
							<sf:hidden id="materialIdentity" path="material.id" onclick="searchmaterial()" maxlength="20"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<sf:input id="materialIdString" path="material.materialId" onclick="searchmaterial()" maxlength="20"
								cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<sf:select id="type" path="type" maxlength="20" cssClass="form-control">
								<sf:option value="" />
								<sf:option value="IN" />
								<sf:option value="OUT"/>
							</sf:select>
				...
				<table
					...
					<c:forEach var="transaction" items="${page.list}" varStatus="loop">
						<tr>
							...
							<td><c:out value="${transaction.customer.familyName}" /></td>
