...
<body class="home">
	<div id="page">
		...
		<div style="float: right; width: 80%;">
			<sf:form servletRelativeAction="saveeditcustomer" method="post"
				...
				<div class="panel panel-default">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input id="familyName" path="familyName" maxlength="20"
								cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
						<sf:label path="firstName" cssClass="col-sm-2 control-label">
							<sp:message code="label.firstname" />
						</sf:label>
						<div class="col-sm-2">
							<sf:input id="firstName" path="firstName" maxlength="20"
								cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input path="phone" maxlength="20" cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input path="address" maxlength="20" cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input path="clientType" maxlength="20"
								cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input path="companyName" maxlength="20"
								cssClass="form-control" />
						</div>
					</div>
					<div class="form-group">
