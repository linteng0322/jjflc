		...
		<div width:100%;">
			...
			<sf:form servletRelativeAction="searchcustomer" method="post"
				...
				<div class="form-group">
					<sf:label path="familyName" cssClass="col-sm-3 control-label">
						<sp:message code="label.familyname" />
					</sf:label>
					<div class="col-sm-2">
						<sf:input path="familyName" maxlength="20" cssClass="form-control" />
					</div>
					<div class="col-sm-2">
				...
				<div class="panel panel-default">
					<table
						...
						<thead>
							<tr>
								<th>&nbsp;</th>
								<th><sp:message code="label.familyname" /></th>
								<th><sp:message code="label.firstname" /></th>
