...
<script type="text/javascript">
	...
	function searchandaddmaterial(uiElement) {
		var popup_width = 1024;
		var popup_height = 600;
		var popup_left = (screen.width - popup_width) / 2;
		var popup_top = (screen.height - popup_height) / 2;
	...
	function searchandaddmaterialgroup(uiElement) {
		var popup_width = 1024;
		var popup_height = 600;
		var popup_left = (screen.width - popup_width) / 2;
		var popup_top = (screen.height - popup_height) / 2;
		...
		window.open(
		'${pageContext.request.contextPath}/materialgroup/searchmaterialgrouptry?uiElement='+uiElement,
		'material', popup_property);
	}
		...
		$('#searchmaterialtable', document)
				.append(
						"<tr><td>"
								 ...
								 */+ "<input id='"
								+ fid+i
								+ "' type='text' name='materialchildren' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+materialId+i
								...
								+ "<input id='"
								+thickness+i
								+ "' type='text' name='thickness' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+color+i
								+ "' type='text' name='color' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+length+i
								+ "' type='text' name='length' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+materialcount+i
								...
								+ "<input id='"
								+stock+i
								+ "' type='text' name='stock' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+materialtype+i
								+ "' type='hidden' name='materialtype' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td></tr>");
	}
	
	function addmaterialElement() {
		var x = document.getElementsByName("materialchildren");
	    var i=x.length;
		var fid = "searchmaterial";
		var materialId = "materialId";
		...
		$('#searchmaterialtable', document)
				.append(
						"<tr><td>"
								...
								+ "<input id='"
								+materialId+i
								+ "' type='search' name='materialId' style='width: 100px; padding: 4px;' onclick='searchandaddmaterial("+ "\""+i+"\"" + ")' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+thickness+i
								+ "' type='text' name='thickness' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								...
								+ "<input id='"
								+materialtype+i
								+ "' type='hidden' name='materialtype' value='material' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td></tr>");
	}
	function addmaterialgroupElement() {
		...
		var materialcount = "materialcount";
		var stock = "stock";
		var materialtype = "materialgroup";
		//var i = 10;
		i = i + 1;
		var id = $(this).parent().next().text();
		id = id.replace("\n", "").replace("\n", "").trim();
		...
		$('#searchmaterialtable', document)
				.append(
						"<tr><td>"
								...
								+ "<input id='"
								+materialId+i
								+ "' type='search' name='materialId' style='width: 100px; padding: 4px;' onclick='searchandaddmaterialgroup("+ "\""+i+"\"" + ")' readonly='readonly'/>"
								+ "</td><td>"
								+ "<input id='"
								+thickness+i
								+ "' type='text' name='thickness' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								...
								+ "<input id='"
								+materialtype+i
								+ "' type='hidden' name='materialtype' value='materialgroup' style='width: 100px; padding: 4px;' readonly='readonly'/>"
								+ "</td></tr>");
	}
</script>
			...
			<sf:form servletRelativeAction="savecreatetransactionsout" method="post"
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<sp:message code="label.transaction" />
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input id="customerIdentity" path="customer.id" maxlength="20"
								cssClass="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<sf:input id="customerFamilyName" path="customer.familyName" maxlength="20"
								cssClass="form-control" />
								<button type="button" onclick="searchcustomer()" class="btn btn-primary">
								<sp:message code="label.search" />
								</button>
				...
				<a onclick="addmaterialElement()" title="Register">
					<span class="glyphicon glyphicon-plus"></span>
				</a>
				<a onclick="addmaterialgroupElement()" title="Register">
					<span class="glyphicon glyphicon-plus"></span>
				</a>
				<div class="panel panel-default">
